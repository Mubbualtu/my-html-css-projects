...
export default function FanPage2() {
  return (
    <div className="fan-page-2">
      <img className="menu-slider" src="assets/vectors/MenuSlider15_x2.svg" />
      <div className="container">
        <div className="status-bar-iphone">
          ...
          <div className="levels">
            <img className="cellular-connection" src="assets/vectors/CellularConnection11_x2.svg" />
            <img className="wifi" src="assets/vectors/Wifi4_x2.svg" />
            <img className="battery" src="assets/vectors/Battery10_x2.svg" />
          </div>
        </div>
