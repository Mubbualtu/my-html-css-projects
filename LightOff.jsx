...
export default function LightOff() {
  return (
    <div className="light-off">
      <img className="menu-slider" src="assets/vectors/MenuSlider10_x2.svg" />
      <div className="status-bar-iphone">
        ...
        <div className="levels">
          <img className="cellular-connection" src="assets/vectors/CellularConnection4_x2.svg" />
          <img className="wifi" src="assets/vectors/Wifi7_x2.svg" />
